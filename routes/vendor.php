...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item']], function () {
            ...
            Route::post('item-wise-report', 'ItemController@item_wise_report')->name('item-wise-report');
            Route::get('item-wise-report-index', 'ItemController@item_wise_report_index')->name('item-wise-report-index');
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.' , 'middleware' => ['module:order']], function () {
            ...
            Route::get('export-orders/{file_type}','OrderController@export_orders')->name('export');
        });
