...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item']], function () {
            ...
            Route::get('get-attributes', 'ItemController@get_attributes')->name('get-attributes');
        ...
        Route::group(['prefix' => 'vendor', 'as' => 'vendor.'], function () {
                ...
                Route::get('get-modules', 'VendorController@get_modules')->name('get-modules');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings','actch']], function () {
            ...
            Route::post('update-app-settings', 'BusinessSettingsController@update_app_settings')->name('update-app-settings');
            Route::get('landing-page-settings/{tab?}', 'BusinessSettingsController@landing_page_settings')->name('landing-page-settings');
            //// Route::get('landing-page-settings', 'BusinessSettingsController@landing_page_settings')->name('landing-page-settings');
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:customerList']], function () {
            ...
            Route::get('export-customers/{file_type}','CustomerController@export_customers')->name('export');
        });
