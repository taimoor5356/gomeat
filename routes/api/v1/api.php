...
Route::post('get-payment-tokens', 'PaymentController@getPaymentTokens');
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('get-otp', 'CustomerAuthController@get_otp');
    ...
    // custom apis
    Route::post('gomt-transaction', 'CustomController@gomtTransaction'); 
    Route::post('gomt-transaction-check', 'CustomController@gomtTransactionCheck');     
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
        ...
        Route::get('get-categories-list', 'VendorController@get_categories');
        ...
        Route::group(['prefix'=>'item'], function(){
            Route::get('categories', 'ItemController@get_categories');
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::get('gomt-discount', 'ConfigController@gomt_discount');
    });
    ...
    Route::group(['middleware'=>['module-check']], function(){    
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
            ...
            Route::get('helper', 'CustomerController@global_helper');

            //pop-up and feedback
            Route::post('set-popup-viewed', 'CustomerController@setPopUpUserMap');
            Route::get('get-popup-viewed', 'CustomerController@getPopUpUserMap');
            Route::post('feedback', 'CustomerController@user_feedback');
        ...
        Route::group(['prefix' => 'items'], function () {
            ...
            Route::post('cart-items', 'ItemController@get_cart_items');
