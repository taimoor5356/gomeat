                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="store_id" class="js-data-example-ajax form-control" id="store_id" onchange="getStoreData('{{url('/')}}/admin/vendor/get-addons?data[]=0&store_id='+this.value,'add_on')"  title="{{translate('messages.select_store')}}" disabled>
                                    @if($campaign->store)
