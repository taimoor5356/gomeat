        ...
        <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-sm-4 mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            ...
                            {{--<!-- <div class="d-block">
                                ...
                                <p> {{translate('messages.of')}} {{$campaign->reviews->count()}} {{translate('messages.reviews')}}
                    ...
                    <div class="col-sm-5">
                        <small class="card-subtitle border-bottom">{{translate('messages.campaign')}} {{translate('messages.info')}}</small>
                        <small class="text-dark">
                            {{translate('messages.campaign')}} {{translate('messages.starts')}} {{translate('messages.from')}} : {{$campaign->start_date->format('Y-M-d')}}
                        </small><br>
                        <small class="text-dark">
                            {{translate('messages.campaign')}} {{translate('messages.ends')}} {{translate('messages.at')}} : {{$campaign->end_date->format('Y-M-d')}}
                        </small><br>
                        <small class="text-dark">
                            {{translate('messages.available')}} {{translate('messages.time')}} {{translate('messages.starts')}} : {{$campaign->start_time->format(config('timeformat'))}}
                        </small><br>
                        <small class="text-dark">
                            {{translate('messages.available')}} {{translate('messages.time')}} {{translate('messages.ends')}} : {{$campaign->end_time->format(config('timeformat'))}}
                        </small>
                    </div>
                    <div class="col-sm-3 border-left text-center">
                        <span class="mb-1">{{translate('messages.store')}} {{translate('messages.info')}}</span>
                        @if($campaign->store)
                    ...
                    <div class="col-12 pt-2">
                        <div class="card">
                            <div class="card-body">
                                <small class="card-subtitle border-bottom">{{translate('messages.item')}} {{translate('messages.info')}}</small>
                                <div class="row">
                                    <div class="col-4 pt-2">
                                        <small class="text-dark">{{translate('messages.price')}} : {{\App\CentralLogics\Helpers::format_currency($campaign['price'])}}
                                        </small class="text-dark"><br>
                                        <small class="text-dark">{{translate('messages.tax')}} :
