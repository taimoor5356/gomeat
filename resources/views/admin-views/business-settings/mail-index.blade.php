        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{ translate('messages.smtp') }} {{ translate('messages.mail') }}
                        {{ translate('messages.setup') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="card card-body">
                            <form class="" action="javascript:">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button type="button" onclick="{{env('APP_MODE') == 'demo' ? 'call_demo()' : 'send_mail()'}}" class="btn btn-primary mb-2 btn-block">
