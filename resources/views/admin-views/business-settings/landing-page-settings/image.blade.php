    ...
    <div class="card my-2">
        <div class="card-body">
            ...
            <form action="{{route('admin.business-settings.landing-page-settings', 'image')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label class="input-label" >{{translate('messages.about_us_image')}}<small style="color: red">* ( {{translate('messages.size')}}: 1241 X 1755 px )</small></label>
                    <div class="custom-file">
            ...
            <form action="{{route('admin.business-settings.landing-page-settings', 'image')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label class="input-label" >{{translate('messages.feature_section_image')}}<small style="color: red">* ( {{translate('messages.size')}}: 1241 X 1755 px )</small></label>
                    <div class="custom-file">
