    ...
    <div class="card my-2">
        <div class="card-body">
            <form action="{{route('admin.business-settings.landing-page-settings', 'speciality')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="input-label" >{{translate('messages.speciality_img')}}<small style="color: red">* ( {{translate('messages.size')}}: 140 X 140 px )</small></label>
                ...
                <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">{{translate('messages.action')}}</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if($speciality)
