        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{translate('messages.firebase')}} {{translate('messages.push')}} {{translate('messages.notification')}} {{translate('messages.setup')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>{{translate('messages.push')}} {{translate('messages.messages')}}</h2>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span
                                                class="d-block">{{translate('messages.order')}} {{translate('messages.pending')}} {{translate('messages.message')}}</span>
                                          </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block"> {{translate('messages.order')}} {{translate('messages.confirmation')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('messages.order')}} {{translate('messages.processing')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block"> {{translate('messages.store')}} {{translate('messages.handover')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('messages.order')}} {{translate('messages.out_for_delivery')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('messages.order')}} {{translate('messages.delivered')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('messages.deliveryman')}} {{translate('messages.assign')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block"> {{translate('messages.deliveryman')}} {{translate('messages.start')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('messages.deliveryman')}} {{translate('messages.delivered')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('messages.order')}} {{translate('messages.canceled')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('messages.order')}} {{translate('messages.refunded')}} {{translate('messages.message')}}</span>
                                              </span>
                                        </label>
