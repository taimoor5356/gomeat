        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{translate('messages.payment')}} {{translate('messages.gateway')}} {{translate('messages.setup')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @csrf
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{translate('messages.store')}} {{translate('messages.id')}} </label><br>
                                    <input type="text" class="form-control" name="store_id"
                                           value="{{env('APP_MODE')!='demo'?($config?$config['store_id']:''):''}}">
                                </div>
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{translate('messages.store')}} {{translate('messages.password')}}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @csrf
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.razorkey')}}</label><br>
                                    <input type="text" class="form-control" name="razor_key"
                                           value="{{env('APP_MODE')!='demo'?($config?$config['razor_key']:''):''}}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.razorsecret')}}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method-update',['senang_pay']):'javascript:'}}"
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{translate('messages.merchant')}} {{translate('messages.id')}}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method-update',['mercadopago']):'javascript:'}}"
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label class="text-capitalize"
                                        style="padding-left: 10px">{{translate('messages.access_token')}}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 10px">{{translate('messages.callback')}}</label>
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.api_key')}}</label><br>
                                    <input type="text" class="form-control" name="api_key"
                                           value="{{env('APP_MODE')!='demo'?$config['api_key']:''}}">
                                </div>

                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.iframe_id')}}</label><br>
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{translate('messages.integration_id')}}</label><br>
                                    <input type="text" class="form-control" name="integration_id"
                                           value="{{env('APP_MODE')!='demo'?$config['integration_id']:''}}">
                                </div>

                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.HMAC')}}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.api_secret')}}</label><br>
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{translate('messages.username')}}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.profile_id')}}</label><br>
                                    <input type="text" class="form-control" name="profile_id"
                                           value="{{env('APP_MODE')!='demo'?$config['profile_id']:''}}">
                                </div>

                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.server')}}</label><br>
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{translate('messages.base_url_by_region')}}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.paytm_merchant_key')}}</label><br>
                                    <input type="text" class="form-control" name="paytm_merchant_key"
                                           value="{{env('APP_MODE')!='demo'?$config['paytm_merchant_key']:''}}">
                                </div>

                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{translate('messages.paytm_merchant_mid')}}</label><br>
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{translate('messages.paytm_merchant_website')}}</label><br>
