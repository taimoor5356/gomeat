                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group p-2">
                                ...
                                <input type="text" name="service_fee" class="form-control" id="service_fee"
                                    value="{{ $service_fee ? $service_fee->value : 0 }}" min="0" max="100" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group p-2">
                                ...
                                <input type="number" name="gomt_discount" class="form-control" id="gomt_discount"
                                    value="{{ $gomt_discount ? $gomt_discount->value : 0.0 }}"  required>
                            </div>
                        </div>
