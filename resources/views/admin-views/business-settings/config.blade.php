        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <span class="badge badge-soft-dark">{{translate('messages.map_api_hint')}}</span><br>
                    <span class="badge badge-soft-dark">{{translate('messages.map_api_hint_2')}}</span><br>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label class="input-label" style="padding-left: 10px">{{translate('messages.map_api_key')}} ({{translate('messages.client')}})</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label class="input-label" style="padding-left: 10px">{{translate('messages.map_api_key')}} ({{translate('messages.server')}})</label>
