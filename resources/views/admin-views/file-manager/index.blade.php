...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item text-capitalize" aria-current="page">{{translate('messages.file_manager')}}</li>
        </ol>
    </nav>
    <!-- Page Heading -->
    <div class="d-md-flex_ align-items-center justify-content-between mb-2">
        <div class="row">
            <div class="col-md-8">
                <h3 class="h3 mb-0 text-capitalize text-black-50">{{translate('messages.file_manager')}}</h3>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card-header py-1">
                ...
                @endphp
                    ...
                    <a class="btn btn-primary" href="{{url()->previous()}}"><i class="tio-left-arrow"></i>{{translate('messages.back')}}</a>
                </div>
