...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{translate('messages.deliverymen_earning_provide')}}  </li>
        </ol>
    </nav>
    ...
    <div class="row" style="margin-top: 20px">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="text-capitalize">{{ translate('messages.deliverymen_earning_provide')}} {{ translate('messages.table')}}</h5>
                </div>
