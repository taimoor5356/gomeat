        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{route('admin.category.add')}}">{{translate('messages.category')}}</a>
                </li>
                <li class="breadcrumb-item">{{translate('messages.bulk_import')}} </li>
            </ol>
        </nav>
        <h1 class="text-capitalize">{{translate('messages.category')}} {{translate('messages.bulk_import')}}</h1>
        <!-- Content Row -->
        <div class="row">
            <div class="col-12">
                ...
                <form class="product-form" action="{{route('admin.category.bulk-import')}}" method="POST"
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4>{{translate('messages.Import Categories File')}}</h4>
