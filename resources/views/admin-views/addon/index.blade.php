...
@section('content')
    <div class="content container-fluid">
        ...
        @php($default_lang = 'en')
        <div class="card">
            <div class="card-header"> <h5>{{translate('messages.add').' '.translate('messages.new')}} {{translate('messages.addon')}}</h5></div>
            <div class="card-body">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <form id="search-form">
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" name="search" class="form-control" placeholder="{{translate('messages.search_addons')}}" aria-label="Search addons">
                            </div>
                            <!-- End Search -->
                        </form>
                    </div>
