                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="store_id" class="form-control  js-data-example-ajax"  data-placeholder="{{translate('messages.select')}} {{translate('messages.store')}}" required oninvalid="this.setCustomValidity('{{translate('messages.please_select_store')}}')">
                                @if($addon->store)
