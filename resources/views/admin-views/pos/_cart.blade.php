<div class="d-flex flex-row" style="max-height: 300px; overflow-y: scroll;">
        <table class="table table-bordered">
            <thead class="text-muted">
                <tr>
                    <th scope="col">{{translate('messages.item')}}</th>
                    <th scope="col" class="text-center">{{translate('messages.qty')}}</th>
                    <th scope="col">{{translate('messages.price')}}</th>
                    <th scope="col">{{translate('messages.delete')}}</th>
                </tr>
            </thead>
            <tbody>
            <?php 
                ...
                <div class="modal-body">
                    <form action="{{route('admin.pos.order')}}?store_id={{request('store_id')}}" id='order_place' method="post" onkeydown="return event.key != 'Enter';">
                        ...
                        <div class="row collapse" id="delivery_address">
                            <div class="form-group col-12">
                                <label class="input-label" for="">{{translate('messages.contact_person_name')}}</label>
                                <input type="text" class="form-control" name="contact_person_name" value="{{old('contact_person_name')}}">
                            </div>
                            <div class="form-group col-12">
                                <label class="input-label" for="">{{translate('messages.contact_person_number')}}</label>
                                <input type="text" class="form-control" name="contact_person_number" value="{{old('contact_person_number')}}">
                            </div>
                            <div class="form-group col-12">
                        ...
                        <div class="form-group col-12 d-flex justify-content-between">
                            <button class="btn btn-sm btn-primary" type="submit">{{translate('messages.submit')}}</button>
                            <button class="btn btn-sm btn-secondary" type="button" data-toggle="collapse" data-target="#delivery_address">{{translate('messages.Delivery address')}}</button>
                        </div>
                    </form>
                </div>
            </div>
