        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-4 col-12 mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{translate('messages.day_wise_report')}} <span class="h6 badge badge-soft-success ml-2" id="itemCount">( {{session('from_date')}} - {{session('to_date')}} )</span></h1>
                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="mb-1">{{translate('messages.total_sell')}}</h4>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="mb-1 text-capitalize">{{translate('messages.in')}} {{translate('messages.progress')}}</h4>
                                            <span class="font-size-sm text-warning">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="mb-1">{{translate('messages.delivered')}}</h4>
                                            <span class="font-size-sm text-success">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="mb-1">{{translate('messages.failed')}}</h4>
                                            <span class="font-size-sm text-danger">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="mb-1">{{translate('messages.canceled')}}</h4>
                ...
                <div class="table-responsive">
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                <th  style="width: 5%">{{translate('messages.sl#')}}</th>
