                            ...
                            <div class="row restaurant-data @if($store->module_id != '2') d-none @endif">
                                ...
                                <div class="form-group col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" disabled id="restaurant_online_payment" name="restaurant_online_payment" class="form-control restaurant_cash_amount_field" disabled placeholder="" value="{{$store->restaurant_online_payment}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" disabled id="restaurant_cash_payment" name="restaurant_cash_payment" class="form-control restaurant_cash_amount_field" disabled placeholder="" value="{{$store->restaurant_cash_payment}}">
                                    </div>
                                </div>
                                <!-- Restaurant -->
                            </div>
