                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="row">
                                                ...
                                                <div class="col col-md-2 align-self-center">
                                                    <h6>@isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset {{ number_format(floatval($detail['price']), 2, '.', ',') }}
                                                    </h6>
                                                </div>
                                                <div class="col col-md-2 align-self-center">
                                                    <h6>{{ $detail['sales_tax'] }} 
                                                ...
                                                <div class="col col-md-3 align-self-center text-right">
                                                    ...
                                                    <h5>@isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset {{ number_format(floatval($amount), 2, '.', ',') }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <dl class="row text-sm-right">
                                    @if (!$parcel_order)
                                        ...
                                        <dd class="col-sm-6">
                                            ...
                                            @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($order['sub_total']), 2, '.', ',') }}
                                        </dd>
                                        {{-- <dt class="col-sm-6">{{ translate('messages.discount') }}:</dt>
                                        <dd class="col-sm-6">
                                            - {{ number_format(floatval($store_discount_amount), 2, ',', '.') }}
                                        </dd> --}}
                                        
                                        <dt class="col-sm-6">{{ translate('messages.coupon') }}
                                            {{ translate('messages.discount') }}:</dt>
                                        <dd class="col-sm-6">
                                                - @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($coupon_discount_amount), 2, '.', ',') }}
                                        </dd>
                                        <dt class="col-sm-6">GOMT Discount %:</dt>
                                        <dd class="col-sm-6">
                                             {{ ($gomt_discount_percent==NULL ? '0.00': $gomt_discount_percent) }} % on 
                                             @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($order['sub_total'] - $coupon_discount_amount), 2, '.', ',')}}
                                        </dd>
                                        <dt class="col-sm-6">GOMT Discount amount:</dt>
                                        <dd class="col-sm-6">
                                             - @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($gomt_discount_amount), 2, '.', ',') }}
                                        </dd>
                                        <dt class="col-sm-6">Total discount:</dt>
                                        <dd class="col-sm-6">
                                             @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($total_discount_amount), 2, '.', ',') }}
                                        </dd>
                                        <dt class="col-sm-6">{{ translate('messages.Service') }}
                                            {{ translate('messages.fee') }} @ {{$order['service_fee_percent']}} %:</dt>
                                        <dd class="col-sm-6">
                                            + @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($order['service_fee_amount']), 2, '.', ',') }}
                                        </dd>
                                        <dt class="col-sm-6">{{ translate('messages.sales_tax') }}:</dt>
                                        <dd class="col-sm-6">
                                            {{-- + {{ \App\CentralLogics\Helpers::format_currency($total_tax_amount) }}</dd> --}}
                                            + @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($order['sales_tax']), 2, '.', ',') }}</dd>
                                        
                                        <dt class="col-sm-6">{{ translate('messages.driver_tips') }}</dt>
                                        <dd class="col-sm-6">
                                            + @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($deliverman_tips), 2, '.', ',') }}</dd>
                                        <dt class="col-sm-6">{{ translate('messages.delivery') }}
                                            {{ translate('messages.fee') }}:</dt>
                                        <dd class="col-sm-6">
                                            + @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($del_c), 2, '.', ',') }}
                                        </dd>
                                        <dt class="col-sm-6">
                                           Wallet Amount :
                                        </dt>
                                        <dd class="col-sm-6">
                                            + @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($order->wallet_amount), 2, '.', ',')}}
                                            <hr>
                                        </dd>
                                    ...
                                    @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($product_price + $del_c + $order['service_fee_amount'] + $order['sales_tax'] + $total_addon_price + $deliverman_tips - $coupon_discount_amount - $gomt_discount_amount), 2, '.', ',') }}
                                        <hr>
                                    ...
                                    <dd class="col-sm-6">
                                    @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($order['gm_commission']), 2, '.', ',') }}
                                    </dd>

                                    <dt class="col-sm-6">{{ translate('messages.GoMeat') }}
                                        {{ translate('messages.Revenue') }}:</dt>
                                    <dd class="col-sm-6">
                                    @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($order['gomeat_revenue']), 2, '.', ',') }}
                                    </dd>

                                    <dt class="col-sm-6">{{ translate('messages.net_to') }}
                                        {{ translate('messages.store') }}:</dt>
                                    <dd class="col-sm-6">
                                    @isset($order->store)@if(!empty($order->store->country->currency_symbol)){{$order->store->country->currency_symbol}}@else $ @endif @else $ @endisset{{ number_format(floatval($order['net_to_store']), 2, '.', ',') }}
                                    </dd>
                                </dl>
                                <!-- End Row -->
                            </div>
