                            ...
                            <div class="col-sm mb-2 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="h3 mb-0">
                                        ...
                                        Total Earning Current Year : {{\App\CentralLogics\Helpers::format_currency(array_sum($earning))}}
                                    </span>
                                </div>
                                <div class="d-flex align-items-center mt-2 mb-2">
                                    <span class="h5 mb-0">
                                        ...
                                        Commission Given Current Year : {{\App\CentralLogics\Helpers::format_currency(array_sum($commission))}}
                                    </span>
                                </div> 
                            </div>
