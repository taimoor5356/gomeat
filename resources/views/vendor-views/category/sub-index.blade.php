        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{translate('messages.sub_category')}}
                    </h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header pb-0">
                        ...
                        {{--<form>
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" class="form-control" placeholder="{{translate('messages.search_sub_categories')}}" aria-label="{{translate('messages.search_sub_categories')}}">
                            </div>
                            <!-- End Search -->
                        </form>--}}
                    </div>
