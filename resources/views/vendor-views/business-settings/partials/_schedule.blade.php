...
<div class="my-2 p-1 border rounded">
    ...
    @endif
    <span class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-dayid="1" data-day="{{translate('messages.monday')}}"><i class="tio-add"></i></span>
</div>
...
<div class="my-2 p-1 border rounded">
    ...
    @else
        <span class="btn btn-sm btn-outline-danger m-1 disabled">{{translate('messages.Offday')}}</span>
    @endif
    <span class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-dayid="2" data-day="{{translate('messages.tuesday')}}"><i class="tio-add"></i></span>
</div>
...
<div class="my-2 p-1 border rounded">
        ...
        @else
            <span class="btn btn-sm btn-outline-danger m-1 disabled">{{translate('messages.Offday')}}</span>
        @endif
        <span class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-dayid="3" data-day="{{translate('messages.wednesday')}}"><i class="tio-add"></i></span>
</div>
...
<div class="my-2 p-1 border rounded">
        ...
        @else
            <span class="btn btn-sm btn-outline-danger m-1 disabled">{{translate('messages.Offday')}}</span>
        @endif
        <span class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-dayid="4" data-day="{{translate('messages.thirsday')}}"><i class="tio-add"></i></span>
</div>
...
<div class="my-2 p-1 border rounded">
        ...
        @else
            <span class="btn btn-sm btn-outline-danger m-1 disabled">{{translate('messages.Offday')}}</span>
        @endif
        <span class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-dayid="5" data-day="{{translate('messages.friday')}}"><i class="tio-add"></i></span>
</div>
...
<div class="my-2 p-1 border rounded">
        ...
        @else
            <span class="btn btn-sm btn-outline-danger m-1 disabled">{{translate('messages.Offday')}}</span>
        @endif
        <span class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-dayid="6" data-day="{{translate('messages.saturday')}}"><i class="tio-add"></i></span>
</div>
...
<div class="my-2 p-1 border rounded">
        ...
        @else
            <span class="btn btn-sm btn-outline-danger m-1 disabled">{{translate('messages.Offday')}}</span>
        @endif
        <span class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-dayid="0" data-day="{{translate('messages.sunday')}}"><i class="tio-add"></i></span>
</div>