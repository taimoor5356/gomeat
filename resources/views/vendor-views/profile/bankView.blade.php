                    ...
                    <div class="card-body">
                        <div class="col-md-8 mt-4">
                            <h4>{{translate('messages.bank_name')}}
                                : {{$data->bank_name ? $data->bank_name : translate('messages.No Data found')}}</h4>
                            <h6>{{translate('messages.branch')}} : {{$data->branch ? $data->branch : translate('messages.No Data found')}}</h6>
                            <h6>{{translate('messages.holder_name')}}
                                : {{$data->holder_name ? $data->holder_name : translate('messages.No Data found')}}</h6>
                            <h6>{{translate('messages.account_no')}}
                                : {{$data->account_no ? $data->account_no : translate('messages.No Data found')}}</h6>
