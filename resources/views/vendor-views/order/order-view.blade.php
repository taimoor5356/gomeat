                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-sm-6">
                                        + {{\App\CentralLogics\Helpers::format_currency($order['sub_total'])}}</dd>
                                    ...
                                    <dd class="col-sm-6">
                                        ...
                                        <dd class="col-sm-6">
                                            {{-- + {{ \App\CentralLogics\Helpers::format_currency($total_tax_amount) }}</dd> --}}
                                            + {{ \App\CentralLogics\Helpers::format_currency($order['sales_tax']) }}
                                    ...
                                    <dd class="col-sm-6"> --}}
                                        {{-- @php($del_c=$order['delivery_charge']) --}}
                                        {{-- {{ \App\CentralLogics\Helpers::format_currency($product_price + $del_c + $order['service_fee_amount'] + $order['sales_tax'] + $total_addon_price + $order->dm_tips - $coupon_discount_amount - $store_discount_amount) }} --}}
