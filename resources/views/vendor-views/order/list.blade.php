                ...
                <table id="datatable"
                    ...
                    @foreach($orders as $key=>$order)
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td>{{\App\CentralLogics\Helpers::format_currency($order['net_to_store'])}}</td>
            ...
            var datatable = $.HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                buttons: [
                    ...
                    // },
                    {
                        ...
                        {
                            window.location.href = '{{route("vendor.order.export",['file_type'=>'excel'])}}';
                        }
                    },
                    {
                        extend: 'csv',
                        ...
                        action: function (e, dt, node, config)
                        {
                            window.location.href = '{{route("vendor.order.export",['file_type'=>'csv'])}}';
                        }
                    },
                    // {
                    //     extend: 'pdf',
