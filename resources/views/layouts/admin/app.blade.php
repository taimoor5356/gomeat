...
<script>
    ...
    function set_store_filter(url, id) {
        ...
        location.href = resetset_pagination(nurl);
        // location.href = nurl;
    }
    ...
    function resetset_pagination(url)
    {
        const newPageValue = 1;

        // Modify the URL or form parameter related to pagination
        const currentUrl = url;
        const updatedUrl = updateUrlParameter(currentUrl, 'page', newPageValue);
    ...
    function updateUrlParameter(url, param, value) {
        ...
        const newUrl = url.toString().replace(pattern, `$1${value}$2`);
        return newUrl;
    }
