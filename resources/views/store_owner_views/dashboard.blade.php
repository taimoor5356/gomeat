...
@section('page_title', 'Dashboard - GoMeat')
@section('content')
<!-- Content wrapper -->
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card card-border-shadow-success h-100">
                    <div class="card-body p-2">
                        ...
                        <p class="mb-1 text-dark"><small class="text-uppercase">confirmed</small></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card card-border-shadow-warning h-100">
                    <div class="card-body p-2">
                        ...
                        <p class="mb-1 text-dark"><small class="text-uppercase">processing</small></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card card-border-shadow-primary h-100">
                    <div class="card-body p-2">
                        ...
                        <p class="mb-1 text-dark"><small class="text-uppercase">ready for delivery</small></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card card-border-shadow-info h-100">
                    <div class="card-body p-2">
                        ...
                        <p class="mb-1 text-dark"><small class="text-uppercase">otw items</small></p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="report-list">
                                    <div class="report-list-item rounded-2 p-3">
                                        <div class="d-flex align-items-start">
                                            <div class="report-list-icon me-2 bg-white rounded py-2">
                                                ...
                                                <span class="avatar-initial rounded bg-white p-3"><i class="bx bx-list-ul text-primary"></i></span>
                                            </div>
                                ...
                                <div class="report-list">
                                    <div class="report-list-item rounded-2 p-3">
                                        <div class="d-flex align-items-start">
                                            <div class="report-list-icon me-2 bg-white rounded py-2">
                                                <!-- <img src="../../assets/svg/icons/paypal-icon.svg" width="22" height="22" alt="Paypal"> -->
                                                <span class="avatar-initial rounded bg-white p-3"><i class="bx bx-time text-info"></i></span>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-end w-100 flex-wrap gap-2">
                                                <div class="d-flex flex-column">
                                                    <span>Scheduled</span>
                                ...
                                <div class="report-list">
                                    <div class="report-list-item rounded-2 p-3">
                                        <div class="d-flex align-items-start">
                                            <div class="report-list-icon me-2 bg-white rounded py-2">
                                                <!-- <img src="../../assets/svg/icons/paypal-icon.svg" width="22" height="22" alt="Paypal"> -->
                                                <span class="avatar-initial rounded bg-white p-3"><i class="bx bx-recycle text-danger"></i></span>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-end w-100 flex-wrap gap-2">
                                                <div class="d-flex flex-column">
                                                    <span>Refunded</span>
                                ...
                                <div class="report-list">
                                    <div class="report-list-item rounded-2 p-3">
                                        <div class="d-flex align-items-start">
                                            <div class="report-list-icon me-2 bg-white rounded py-2">
                                                <!-- <img src="../../assets/svg/icons/paypal-icon.svg" width="22" height="22" alt="Paypal"> -->
                                                <span class="avatar-initial rounded bg-white p-3"><i class="bx bxs-check-circle text-success"></i></span>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-end w-100 flex-wrap gap-2">
                                                <div class="d-flex flex-column">
                                                    <span>Delivered</span>
            ...
            <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                <div class="card">
                    <div class="row row-bordered g-0">
                        <div class="col-md-8">
                            <h5 class="card-header m-0 me-2 pb-3">Total Sell</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 order-0 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">Top Selling Items</h5>
                        <div class="dropdown">
            ...
            <div class="col-md-6 col-lg-6 order-0 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">Top Rated Item</h5>
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="transactionID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="bx bx-dots-vertical-rounded"></i>
                            </button>
                ...
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                        <div class="card-title mb-0">
                            <h5 class="m-0 me-2">Most Rated Items</h5>
