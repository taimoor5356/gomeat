        ...
        <section class="col-lg-12">
            <div class="checkout_details mt-3">
                <div class="row">
                    ...
                    @if($config['status'])
                        <div class="col-md-6 mb-4 col-lg-12" style="cursor: pointer">
                            <div class="card">
                    ...
                    @if($config['status'])
                        ...
                        <br>
                        <br>
                            <h4>Select <span style = "color:blue">Stripe</span> for payment via Debit/Credit Card</h4>
                            <div class="card">
                    ...
                    {{-- <div class="col-md-6 mb-4" style="cursor: pointer">
                        <div class="card">
                            <div class="card-body pb-0 pt-1" style="height: 60px">
                                <form class="needs-validation" method="GET" id="payment-form"
                                      action="{{route('pay-coinbase')}}">
                                    {{ csrf_field() }}
                                    <button class="btn btn-block click-if-alone" type="submit">
                                        <img width="120"
                                             src="{{asset('public/assets/admin/img/coinbase.png')}}"/>
                                    </button>
                                </form>
                            </div>
                        </div>
