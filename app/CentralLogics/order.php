    ...
    public static function create_transaction($order, $received_by=false, $status = null)
    {
        ...
        try{
            OrderTransaction::insert([
                ...
                'store_amount'=>$order->net_to_store,
                // 'admin_commission'=>$comission_amount - $admin_subsidy,
                'admin_commission'=>$order->gm_commission,
            ...
            $adminWallet->total_commission_earning = $adminWallet->total_commission_earning + $order->gm_commission;
            ...
            if($type != 'parcel')
            {
                ...
                if($order->store->self_delivery_system)
                {
                    ...
                    $vendorWallet->total_earning = $vendorWallet->total_earning + $order->net_to_store;
                }
                else{
