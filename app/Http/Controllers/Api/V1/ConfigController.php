...
class ConfigController extends Controller
{
    ...
    public function configuration(Request $request)
    {
        ...
        return response()->json([
            ...
            'per_km_shipping_charge' => (!empty($request['country_code']) && ($request['country_code'] == "PK")) ? 30 : (double)$settings['per_km_shipping_charge'],
            ...
            'module'=>$module,
            'parcel_per_km_shipping_charge' => (!empty($request['country_code']) && ($request['country_code'] == "PK")) ? 30 : (float)$settings['parcel_per_km_shipping_charge'],
